    ...
    <div id="usual1" class="usual">
        <div class="itab">
            <ul>
                ...
                <li><a href="newadmin.php">新闻详情</a></li>
            </ul>
        </div>
        <div id="tab1" class="tabson">
            <ul class="forminfo">
                <form action="newsave.php" method="post">
                    ...
                    <li><label>新闻标题</label><input type="text" name="title" placeholder="产品名称" size="70" class="dfinput">
                    </li>
                    <li><label>是否显示</label>
